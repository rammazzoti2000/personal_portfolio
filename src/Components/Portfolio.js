                ...
                <article className="col-12 col-12-xsmall work-item">
                  ...
                  <div className="art-description">
                    <div className="text-wrapper">
                      ...
                      <p>React capstone based on a catalog of statistics that is a browsable list of items and can be filtered and accessed the details of one item.</p>
                    </div>
                    <ul className="actions">
                      <div className="actions-wrapper">
                        ...
                        <li><a href="https://github.com/rammazzoti2000/react_capstone" className="button project-button brands" target="_blank" rel="noopener noreferrer"><i className="fa fa-github icon"></i>View Source</a></li>
                      </div>
                      <div className="languages">
                        <i className="devicon-react-plain-wordmark technology"></i>
                      </div>
